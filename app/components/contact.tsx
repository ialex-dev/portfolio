  ...
  return (
    <section className="relative overflow-hidden bg-zinc-900 py-20">
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          <h2 className="mb-4 text-3xl font-bold tracking-tighter sm:text-4xl">Let's Build Together</h2>
          <p className="mb-8 text-gray-400">
            Have a project in mind or interested in collaborating? I'd love to hear from you. Reach out and let's create
            something amazing.
          </p>
        </motion.div>
        <motion.div
